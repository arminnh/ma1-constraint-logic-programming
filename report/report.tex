...
\end{table}
When we compare both tables, we see that for the alternative viewpoint there is a good improvement. Although when we look for the classic viewpoint, we see that our heuristic is in most cases quite a bit slower! Although in some cases it does increase it tremendously.
